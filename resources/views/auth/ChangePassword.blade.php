...
@section('content')
            ...
            <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
                <div class="col-first">
                    ...
                    <nav class="d-flex align-items-center">
                        ...
                        <a href="/auth/">Изменение учетных данных</a>
                    </nav>
                </div>
            </div>
        </div>
    ...
    <!--================Login Box Area =================-->
    <section id="loginPage" class="login_box_area section_gap" >
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="login_form_inner">
                        ...
                        <form class="row login_form" id="loginForm" novalidate="novalidate">
                            <div class="col-md-12 form-group">
                                <input type="email" class="form-control" v-model="email" id="email" placeholder="Email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email'">
                            </div>
                            <div class="col-md-12 form-group">
